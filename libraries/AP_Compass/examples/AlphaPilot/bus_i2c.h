...
bool i2cWriteInitiate(I2CDevice device, uint8_t target_, uint8_t addrSize, const uint8_t *addr, uint8_t len, const uint8_t *data);
...
bool i2cReadInitiate(I2CDevice device, uint8_t target_, uint8_t addrSize, const uint8_t *addr, uint8_t len, uint8_t* buf);
